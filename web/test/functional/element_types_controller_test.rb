...
class ElementTypesControllerTest < ActionController::TestCase
  ...
  test "should create element_type" do
    assert_difference('ElementType.count') do
      post :create, element_type: { class_name: @element_type.class_name, description: @element_type.description, name: @element_type.name, options: @element_type.options }
    end
  ...
  test "should update element_type" do
    put :update, id: @element_type, element_type: { class_name: @element_type.class_name, description: @element_type.description, name: @element_type.name, options: @element_type.options }
    assert_redirected_to element_type_path(assigns(:element_type))
  end

...
class RoomTypesControllerTest < ActionController::TestCase
  ...
  test "should create room_type" do
    assert_difference('RoomType.count') do
      post :create, room_type: { class_name: @room_type.class_name, description: @room_type.description, name: @room_type.name, options: @room_type.options }
    end
  ...
  test "should update room_type" do
    put :update, id: @room_type, room_type: { class_name: @room_type.class_name, description: @room_type.description, name: @room_type.name, options: @room_type.options }
    assert_redirected_to room_type_path(assigns(:room_type))
  end
